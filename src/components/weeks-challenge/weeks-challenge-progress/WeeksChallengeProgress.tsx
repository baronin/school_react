...
const WeeksChallengeProgress = () => {
  ...
  const liItem = icons.map((item, i) => {
    const taskComplete = i ? <span className="weeks-challenge__progress-task-complete">
          <p className="weeks-challenge__progress-xp">+300px</p>
        </span> : null;
    const taskCompleteLast = i === 2 ? <span className="weeks-challenge__progress-task-complete-last">
          <p className="weeks-challenge__progress-xp">+300px</p>
        </span> : null;
    const activeClass = i === 0 ? 'weeks-challenge__progress-item weeks-challenge__progress-item--active' : 'weeks-challenge__progress-item';
    return (
